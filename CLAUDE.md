...
**Aktueller Umsetzungsplan:** `PLAN4.md` (Runde 4, 25 Punkte; Priorität 1 = Phase A, mobiler Erststart) — Punkte einzeln umsetzen, je ein Commit mit Prefix `Plan4-N:`, Arbeitsregeln und Ausgangsanalyse am Anfang der Plandatei beachten. (Runde 1, `PLAN2.md` und `PLAN3.md` sind vollständig umgesetzt.)
